 ...
 */
export default function get_html_translation_table (table: string, quoteStyle: string = '') {
    let entities: any = {};
    let hashMap: any = {};
    let decimal: any;
    let constMappingTable: any = {};
    let constMappingQuoteStyle: any = {};
    let useTable: any = {};
    let useQuoteStyle: any = {};
