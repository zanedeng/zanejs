...
| --- | --- | --- |
| `zane-input--blur` | Emitted when the input loses focus. | `CustomEvent<any>` |
| `zane-input--change` | Emitted when the value has changed. | `CustomEvent<any>` |
| `zane-input--focus` | Emitted when the input has focus. | `CustomEvent<any>` |
| `zane-input--input` | Emitted when a keyboard input occurred. | `CustomEvent<any>` |
