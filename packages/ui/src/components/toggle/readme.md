...
| --- | --- | --- |
| `zane-toggle--blur` | Emitted when the input loses focus. | `CustomEvent<any>` |
| `zane-toggle--change` | On change of input a CustomEvent 'zane-change' will be triggered. Event details contains parent event, oldValue, newValue of input. | `CustomEvent<any>` |
| `zane-toggle--focus` | Emitted when the input has focus. | `CustomEvent<any>` |
